...
export const InsuranceTypes = () => {
  ...
  return (
    <section className="relative bg-[#F1F5F9] noise-overlay py-20 sm:py-24">
          ...
          >
            {insuranceTypes.map((insurance, index) => (
              <motion.div
                ...
                className="group relative flex-shrink-0 snap-center flex flex-col items-center rounded-xl bg-white border border-slate-200 shadow-sm p-6 cursor-pointer overflow-hidden transition-all duration-300 hover:shadow-lg hover:shadow-blue-900/10 hover:border-secondary min-w-[180px] sm:min-w-[200px]"
              >
                ...
                <div className="relative z-10 w-full">
                  <div className="mb-4 flex h-14 w-14 items-center justify-center rounded-2xl bg-secondary/10 transition-all duration-300 group-hover:bg-secondary/20 group-hover:scale-110 mx-auto">
                    <insurance.icon 
                      size={28} 
                  ...
                  {/* Action indicator */}
                  <div className="flex items-center justify-center gap-1 text-xs text-muted-foreground/60 group-hover:text-secondary transition-colors duration-300">
                    <span className="opacity-0 group-hover:opacity-100 transition-opacity duration-300">Cotar</span>
